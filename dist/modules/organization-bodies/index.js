...
import { CreateForumCommand, UpdateForumCommand, AssignForumAdminCommand, CreateAreaCommand, UpdateAreaCommand, AssignAreaAdminCommand, CreateUnitCommand, UpdateUnitCommand, AssignUnitAdminCommand, } from './application/commands';
...
const controller = new OrganizationBodiesController(forumService, areaService, unitService, createForumCmd, updateForumCmd, assignForumAdminCmd, createAreaCmd, updateAreaCmd, assignAreaAdminCmd, createUnitCmd, updateUnitCmd, assignUnitAdminCmd);
// Export router
